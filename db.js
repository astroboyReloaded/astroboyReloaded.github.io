...
const data = [
  ...
  },
  {
    ...
    tech: ['HTML/CSS', 'JavaScript'],
    description:
      'This project is an original design of mine, and it is an App that I actually use on a daily basis. It\'s purpose is to help traders calculate and manage they risk during financial market trades. The project shows my JavaScript, OOP and Functional Programming skills when it comes to building an app; I deliberately not use any library or framework for this purpose. The app uses the Local Storagefor the DB, and manages shared state across the app. You can save your calculated possitions, reload them, and keep your current balance and risk percentage in memory for future calculations. Additionally, you can copy and paste the values to easily place a position in your favorite Trading App. The project is a work in progress, and currently you will see the most updated version under testing. This project was my first app ever built 2 months into my programing journey when I first started learning HTML, SCC and JavaScript (today I can\'t beleive that code even worked :D! I started refactoring this project at the beginning of this year, exactly two years after I learned my first line of code. A React version of this project is the planning, but this one continues to serve a purpose.',
